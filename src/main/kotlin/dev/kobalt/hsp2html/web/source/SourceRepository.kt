...
package dev.kobalt.hsp2html.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.hsp2html.jvm", "Application", "Executable JAR that is used to convert pages."),
        Triple("dev.kobalt.hsp2html.web", "Frontend", "Website server that uses executable JAR for conversion.")
    )
